...
console.log("La somma è?", crazySum(3, 6));
/* ESERCIZIO 3
...
/* SCRIVI QUI LA TUA RISPOSTA */
const crazyDiff = function (a, b = 19) {
  if (a > 19) {
    return (a - b) * 3;
  } else {
    return a - b;
...
console.log("La differenza è?", crazyDiff(20));
...
console.log("Sarà vero?!", boundary(78));
/* ESERCIZIO 5
